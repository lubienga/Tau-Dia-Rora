...
<body>
        ...
        <div class="container-fluid">
          <div class="contact_link-container">
            <a href="" class="contact_link1">
              ...
              <span>
               Office Park, Magwa Cres, Midrand
              </span>
            </a>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                      Tau Dia Rora (PTY) LTD is a dynamic and fast-growing security and risk management firmheadquartered in Johannesburg, South Africa.
                    </p>
                    <div class="btn-box">
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                      Founded in 2020, the company has quickly established i tself as an innovative and agile player in the security industry, experiencing exponential growth in just a few short years.
                    <div class="btn-box">
                      <a href="" class="btn-1"> Read more </a>
                      <a href="" class="btn-2">Get A Quote</a>
                    </div>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                     Despite launching ding the global COVID- 19 pandemic, Tau Dia Rora has defied expectations and flourished
                    <div class="btn-box">
                      <a href="" class="btn-1"> Read more </a>
                      <a href="" class="btn-2">Get A Quote</a>
                    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            <p>
             Tau Dia Rora (PTY) LTD is a dynamic and fast-growing security and risk management firm headquartered in Johannesburg, South Africa.Founded in 2020, the company has quickly established itself as an innovative and agileplayer in the security industry, experiencing exponential growth in just a few short years.
            </p>
 ...
 -->
             ...
             <h3>Vision Statement</h3>
              ...
              <p>To be the global leader in innovative security solutions, creating a safer world where organisations and individuals can thrive without fear.   </p>

              <h3>Mission Statement</h3>

              <p>Our mission is to revolutionise the security and risk management landscape by providing cutting-edge,adaptable solutions that safeguard our clients' assets, personnel, and operations in an ever-changing globalenvironment. </p>
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
                  Next- generation threat detection,Cloud security solutions,
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Data- driven risk analysis,   Predictive risk modelling,
               Customised risk mitigation strategies
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
                  ...
                  AI- powered due diligence investigations, 
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                  Virtual reality- based security training,
          ...
          <div class="carousel-item active">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                   Best security campany in Johannesburg
                </p>
              </div>
            </div>
          </div>
  ...
  <section class="team_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          Our executive team combines extensive experience in business operations and cybersecurity. The leadership includes
seasoned professionals in key roles such as CEO, Security Management and
Compliance, each bringing valuable insights from their backgrounds in corporate management, financial
strategy, and global operations. With significant experience in threat
prevention, encryption technology, and building secure systems.
<p>Together, this team possesses the diverse skill set
necessary to drive our company's growth while maintaining a strong focus on
security and risk management.
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_logo">
            ...
            <p>
              Tau Dia Rora (PTY) LTD is a dynamic and fast-growing security and risk management firm headquartered in Johannesburg, South Africa.
            </p>
          </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          ...
          <div class="info_contact">
            <a href="" class="">
              <i class="fa fa-map-marker" aria-hidden="true"></i>
              <span>
               Ground Floor, Mac Mac Building, Maxwell Office Park, Magwa Cres, Midrand, 2090
              </span>
            </a>
            <a href="" class="">
              <i class="fa fa-phone" aria-hidden="true"></i>
  ...
  <footer class="container-fluid footer_section">
    <p>
      ...
      <a href="https://itusolutions.co.za/">Itu solutions</a> Distribution by
      <a href="https://">Tau Dia Roara (PTY) LTD</a>
    </p>
  </footer>
  <!-- footer section -->
